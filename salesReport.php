        ...
        <div class="reports-dropdown">
          <a href="#" class="list-group-item active" id="reports-toggle">
           ...
           <div class="submenu" id="reports-submenu">
            ...
            <a href="salesReport.php" class="sub-list-item active">
            ...
            <div class="card-body mt-1">
              <table id="example" class="table table-striped" style="width:100%">
                <thead>
                  ...
                  $fetch_query = "SELECT * FROM completed_orders";
                  ...
                  if (count($suppliers) > 0) {
                      foreach ($suppliers as $row) {
                          ?>
                          <tr>
                              <td class="product_id" ><?php echo htmlspecialchars($row['order_id']); ?></td>
