...
<body>
   ...
   <div class="d-flex content">
    ...
    <div class="card mt-5 mb-4 shadow" style="width: 100%;">
        ...
        <div class="card-body body-level">
            <div class="row">
                <div class="col-md-6">
                    <p class="stock-name" style="margin-top: 50px; font-weight: 500; font-size: 24px; text-align: center;">
                        Top 3
                    </p>
                    <ul class="list-group shadow" id="top-selling-products" style="margin-top: 40px; height: 200px; overflow-y: auto; scrollbar-width: thin; scrollbar-color: #d69f7e #f1f1f1;">
